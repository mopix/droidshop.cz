...
{{--
    Retail card: bordered, rounded, white against the page's warm grey, with
    availability and a way into the detail. The catalogue reading — a shopper
    comparing rows, not browsing a lookbook — wants the facts on the tile.
--}}
