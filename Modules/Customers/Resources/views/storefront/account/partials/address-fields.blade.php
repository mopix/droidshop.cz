...
<fieldset>
    <legend class="field-label">Typ adresy</legend>
    <div class="mt-1 flex gap-4">
        <label class="flex items-center gap-2 text-sm text-slate-700">
            <input type="radio" name="kind" value="shipping"
                   ...
                   class="border-slate-300 text-brand focus:ring-brand">
            Doručovací
        </label>
        <label class="flex items-center gap-2 text-sm text-slate-700">
...
<div>
    <label for="company" class="field-label">Firma <span class="font-normal text-slate-500">(nepovinné)</span></label>
...
<div class="grid grid-cols-2 gap-4">
    <div>
        <label for="reg_no" class="field-label">IČO <span class="font-normal text-slate-500">(nepovinné)</span></label>
    ...
    <div>
        <label for="vat_no" class="field-label">DIČ <span class="font-normal text-slate-500">(nepovinné)</span></label>
...
<div>
    <label for="is_default" class="flex items-center gap-2 text-sm text-slate-700">
