...
Route::get('/recenze/{token}', [ReviewFormController::class, 'show'])->name('form');
Route::post('/recenze/{token}', [ReviewFormController::class, 'store'])->name('store');
Route::get('/recenze/{token}/odhlasit', [ReviewFormController::class, 'optout'])->name('optout');
